define(["jquery", "json2", "backbone", "log4javascript"],
	function(jquery, json2, backbone, log4javascript) {
		...
		PosterApp.AppView = Backbone.View.extend({
		    ...
		    initialize: function (options) {
		    	...
		    	this.models.selectedParticipantsModel.fetch({reset: true});
		    ...
		    rebuildParticipantList: function (event) {
				...
				this.models.participantList.fetch({reset: true});
		    },
